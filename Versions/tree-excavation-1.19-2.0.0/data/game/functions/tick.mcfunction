...
execute as @a[scores={treeex-wood9=1},nbt={SelectedItem:{id:"minecraft:netherite_axe",Count:1b,tag:{display:{Name:'{"text":"Lumberjack Axe","color":"gold","bold":true,"underlined":true}',Lore:['{"text":"Due to the special Blessing that this axe received,","color":"dark_purple"}','{"text":"it can chop down entire Trees at once.","color":"dark_purple"}']},Enchantments:[{}]}}}] at @s run function game:detect_block
