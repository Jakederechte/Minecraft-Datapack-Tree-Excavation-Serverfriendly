...
scoreboard objectives remove treeex-wood9
...
scoreboard objectives add treeex-wood9 minecraft.mined:minecraft.mangrove_log
scoreboard players add @a treeex-wood9 0
